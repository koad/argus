...
- **Authority chain:** koad → Juno → argus
- **Cryptographic identity:** Keys in ~/.argus/id/
- **Located at:** $HOME = ~/.argus
- **Repository:** koad/argus (GitHub)
- **Git identity:** Argus <argus@kingofalldata.com>
